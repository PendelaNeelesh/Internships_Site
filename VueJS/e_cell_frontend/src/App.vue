...
<div class="app_container">
  ...
  <div class="container p-4">
    ...
    <section class="mb-4">
      <!-- Facebook -->
      <a class="btn btn-outline-light btn-floating m-1" target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/" role="button"
        ><font-awesome-icon :icon="['fab', 'facebook']" />
      </a>
      <!-- Instagram -->
      <a class="btn btn-outline-light btn-floating m-1"  target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/" role="button"
        ><font-awesome-icon :icon="['fab', 'instagram']" />
      </a>
      <!-- Github -->
      <a class="btn btn-outline-light btn-floating m-1"  target="_blank" rel="noopener noreferrer" href="https://github.com/PendelaNeelesh/VueJS" role="button"
    ...
    data(){
     ...
     methods: {
      ...
      clearsession(){
        ...
        location.href='http://18.222.77.7:8000/';
